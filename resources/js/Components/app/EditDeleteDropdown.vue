<script setup>
import {EllipsisVerticalIcon, EyeIcon, TrashIcon, PencilIcon} from "@heroicons/vue/20/solid/index.js";
...
<template>
    <Menu as="div" class="relative  inline-block text-left">
        <div>
            <MenuButton
                class="w-8 h-8 z-10 rounded-full hover:bg-black/5 transition flex items-center
                                        justify-center"
            >
            ...
            >
                <div class="px-1 py-1">
                    <MenuItem v-slot="{ active }">
                        <Link :href="route('post.view', props.post.id)"
                            :class="[
