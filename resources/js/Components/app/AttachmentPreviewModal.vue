...
const emit = defineEmits(['update:modalValue', 'update:index', 'hide'])
...
function resetModal() {
    // Define the logic to reset the modal state here
            ...
            <Dialog as="div" @close="closeModal" class="relative z-50">
                ...
                <div class="fixed inset-0 overflow-y-auto">
                    ...
                    >
                        ...
                        >
                            <DialogPanel
                                class="flex flex-col w-full  transform overflow-hidden  bg-slate-500
                            ...
                            >
                                ...
                                <div class="relative group h-full ">
                                    <div @click="prev" class="absolute opacity-0 group-hover:opacity-100 text-white
                                    cursor-pointer flex items-center w-16 h-full left-0 bg-black/5">
                                        <ChevronLeftIcon  class="w-12 h-12"/>
                                    </div>
                                    <div @click="next" class="absolute opacity-0 group-hover:opacity-100 text-white
                                    cursor-pointer flex items-center w-16 h-full right-0 bg-black/5">
